...
- [Install main softs](https://caskroom.github.io/search)
	- `brew cask install alfred google-chrome slack firefox skype sketch visual-studio-code iterm2 flux bettertouchtool zeplin appcleaner vlc figma airtable notion loom`
